...
void main() {
  testWidgets('Move 0 to 3', (WidgetTester tester) async {
    ...
    var from = state.layers.first, to = state.layers[3];
    expect(
      [
        from.position,
        to.position,
    ...
    expect([from.position, to.position], [Offset(0, 100), Offset(200, 0)]);
  });
  ...
  testWidgets('Move 3 to 0', (WidgetTester tester) async {
    ...
    var from = state.relationship.entries.elementAt(3).value,
        to = state.relationship.entries.elementAt(0).value;
    expect([from.position, to.position], [Offset(0, 100), Offset(0, 0)]);
    TestGesture gesture =
        await tester.startGesture(from.position + Offset(50, 50));
    await tester.pump(kLongPressTimeout);
    expect(state.pickUp, from);
  ...
  testWidgets('Move 0 to 6', (WidgetTester tester) async {
    ...
    var from = state.relationship.entries.elementAt(0).value,
        to = state.relationship.entries.elementAt(6).value;
    expect([from.position, to.position], [Offset(0, 0), Offset(0, 200)]);
    TestGesture gesture =
        await tester.startGesture(from.position + Offset(50, 50));
    await tester.pump(kLongPressTimeout);
    expect(state.pickUp, from);
  ...
  testWidgets('Move 6 to 0', (WidgetTester tester) async {
    ...
    var from = state.relationship.entries.elementAt(6).value,
        to = state.relationship.entries.elementAt(0).value;
    expect([from.position, to.position], [Offset(0, 200), Offset(0, 0)]);
    TestGesture gesture =
        await tester.startGesture(from.position + Offset(50, 50));
    await tester.pump(kLongPressTimeout);
    expect(state.pickUp, from);
  ...
  testWidgets('Move 5 to 8', (WidgetTester tester) async {
    ...
    var from = state.relationship.entries.elementAt(5).value,
  ...
  testWidgets('Move 8 to 5', (WidgetTester tester) async {
    ...
    var from = state.relationship.entries.elementAt(8).value,
